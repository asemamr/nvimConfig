...
require('lazy').setup({
  ...
  { -- Fuzzy Finder (files, lsp, etc)
    ...
    config = function()
      ...
      -- Define a custom utility function to get the buffer's directory
      ...
      vim.keymap.set('n', '<leader>sh', builtin.help_tags, { desc = '[S]earch [K]eymaps' })
      vim.keymap.set('n', '<leader>sk', builtin.keymaps, { desc = '[S]earch [K]eymaps' })
      vim.keymap.set('n', '<C-q>', builtin.find_files, { desc = '[S]earch [F]iles' })
      vim.keymap.set('n', '<C-p>', '', {
        callback = function()
          builtin.git_files { cwd = buffer_dir() }
        end,
